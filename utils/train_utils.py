...
def create_end_to_end_eval_step(encoder, decoder, diffusion_model, mesh, use_conditioning=False, save_path=None, y_min=None, y_max=None):
    @partial(
        shard_map,
        mesh=mesh,
    ...
    def eval_step(fae_state, diffusion_state, batch):
        ...
        z_generated, _ = sample_ode(
            diffusion_state, z0, z_condition, num_steps=20, use_conditioning=use_conditioning
        )
